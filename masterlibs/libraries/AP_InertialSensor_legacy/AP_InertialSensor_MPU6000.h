...
public:
    ...
    virtual void set_bus_speed(AP_HAL::SPIDevice::Speed speed) = 0;
...
{
public:
    AP_MPU6000_BusDriver_SPI(AP_HAL::OwnPtr<AP_HAL::SPIDevice> dev);
    void init(bool &fifo_mode, uint8_t &max_samples);
    void read8(uint8_t reg, uint8_t *val);
    void write8(uint8_t reg, uint8_t val);
    void set_bus_speed(AP_HAL::SPIDevice::Speed speed);
...
{
public:
    AP_MPU6000_BusDriver_I2C(AP_HAL::OwnPtr<AP_HAL::I2CDevice> dev);
    void init(bool &fifo_mode, uint8_t &max_samples);
    void read8(uint8_t reg, uint8_t *val);
    void write8(uint8_t reg, uint8_t val);
    void set_bus_speed(AP_HAL::I2CDevice::Speed speed);
    void read_burst(uint8_t* samples,
                    AP_HAL::DigitalSource *_drdy_pin,
                    uint8_t &n_samples);
    AP_HAL::Semaphore* get_semaphore();
...
private:
    uint8_t _addr;
    AP_HAL::OwnPtr<AP_HAL::I2CDevice> _i2c;

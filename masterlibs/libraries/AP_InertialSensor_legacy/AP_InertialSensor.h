...
#ifndef __AP_INERTIAL_SENSOR_LEGACY_H__
#define __AP_INERTIAL_SENSOR_LEGACY_H__
...
public:
    ...
    ///
    void init(uint16_t sample_rate, Start_style style = Start_style::COLD_START);
...
#endif // __AP_INERTIAL_SENSOR_LEGACY_H__

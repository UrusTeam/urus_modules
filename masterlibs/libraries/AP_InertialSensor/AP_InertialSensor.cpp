...
const AP_Param::GroupInfo AP_InertialSensor::var_info[] PROGMEM = {
    ...
    // @Units: rad/s
    // @User: Advanced
    //AP_GROUPINFO("GYR3OFFS",   10, AP_InertialSensor, _gyro_offset[1],   0),
    ...
    // @Range: 0.8 1.2
    // @User: Advanced
    //AP_GROUPINFO("ACC3SCAL",    16, AP_InertialSensor, _accel_scale[1],   0),
    ...
    // @Range: -3.5 3.5
    // @User: Advanced
    //AP_GROUPINFO("ACC3OFFS",    17, AP_InertialSensor, _accel_offset[1],  0),
    ...
    // @Values: 0:Disabled,1:Enabled
    // @User: Advanced
    AP_GROUPINFO("USE2", 21, AP_InertialSensor, _use[1],  0),
    ...
    // @Values: 0:Disabled,1:Enabled
    // @User: Advanced
    //AP_GROUPINFO("USE3", 22, AP_InertialSensor, _use[1],  0),
    ...
    // @Units: m
    // @User: Advanced
    //AP_GROUPINFO("POS3", 29, AP_InertialSensor, _accel_pos[1], 0.0f),
    ...
    // @ReadOnly: True
    // @User: Advanced
    //AP_GROUPINFO("GYR3_ID", 32, AP_InertialSensor, _gyro_id[1], 0),
    ...
    // @ReadOnly: True
    // @User: Advanced
    //AP_GROUPINFO("ACC3_ID", 35, AP_InertialSensor, _accel_id[1], 0),
...
#else
    bool saved = _gyro_id[_gyro_count];
#endif
...
#else
    _gyro_id[_gyro_count] = (int32_t)id;
#endif
...
#else
    bool saved = _accel_id[_accel_count];
#endif
...
#else
    _accel_id[_accel_count] = (int32_t)id;
#endif
...
bool AP_InertialSensor::_calculate_trim(const Vector3f &accel_sample, float& trim_roll, float& trim_pitch)
{
    ...
    if (fabsf(trim_roll) > radians(10) ||
        ...
        hal.console->printf_PS(PSTR("INS E-07\n"));
        return false;
    }
#if !HAL_MINIMIZE_FEATURES_AVR
...
void AP_InertialSensor::_acal_save_calibrations()
{
...
#else
            _accel_offset[i] = Vector3f();
            _accel_scale[i] = Vector3f();
#endif
        }
    }
    ...
    if (fabsf(_trim_roll) > radians(10) ||
        ...
        hal.console->printf_PS(PSTR("INS E-08"));
